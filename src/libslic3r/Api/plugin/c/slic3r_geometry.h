...
distf_t c_point_distance_to(c_point lhs, c_point rhs);
...
int32_t points_is_valid(const multipoint_const_view *me);
int32_t points_intersection(const multipoint_const_view *me, c_point line_a, c_point line_b, c_point *out_intersection);
int32_t points_first_intersection(const multipoint_const_view *me, c_point line_a, c_point line_b, c_point *out_intersection);
/*
Returns the number of intersection points.
Stores them into out_intersections until it is full or all intersections are stored.
*/
uint32_t points_intersections(const multipoint_const_view *me, c_point line_a, c_point line_b, multipoint_view *out_intersections);
...
int32_t polygon_split(const polygon_handle *polygon_me, uint32_t index, polyline_handle *polyline_out);
