...
#ifndef steps_stepextrusionsimplification_hpp_
#define steps_stepextrusionsimplification_hpp_
...
namespace Steps::StepExtrusionSimplification {
...
#endif // steps_stepextrusionsimplification_hpp_
