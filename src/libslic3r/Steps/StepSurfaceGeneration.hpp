...
#ifndef steps_stepsurfacegeneration_hpp_
#define steps_stepsurfacegeneration_hpp_
...
namespace Steps::StepSurfaceGeneration {
...
#endif // steps_stepsurfacegeneration_hpp_
