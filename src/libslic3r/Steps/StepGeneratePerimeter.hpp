...
#ifndef steps_stepgenerateperimeter_hpp_
#define steps_stepgenerateperimeter_hpp_
...
namespace Steps::StepGeneratePerimeter {
...
#endif // steps_stepgenerateperimeter_hpp_
