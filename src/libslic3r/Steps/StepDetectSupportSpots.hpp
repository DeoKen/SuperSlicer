...
#ifndef steps_stepdetectsupportspots_hpp_
#define steps_stepdetectsupportspots_hpp_
...
namespace Steps::StepDetectSupportSpots {
...
#endif // steps_stepdetectsupportspots_hpp_
