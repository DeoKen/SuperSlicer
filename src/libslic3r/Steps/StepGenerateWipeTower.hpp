...
#ifndef steps_stepgeneratewipetower_hpp_
#define steps_stepgeneratewipetower_hpp_
...
namespace Steps::StepGenerateWipeTower {
...
#endif // steps_stepgeneratewipetower_hpp_
