...
#ifndef steps_stepdetectsurfacetype_hpp_
#define steps_stepdetectsurfacetype_hpp_
...
namespace Steps::StepDetectSurfaceType {
...
#endif // steps_stepdetectsurfacetype_hpp_
