...
#ifndef steps_stepgroupinfillregions_hpp_
#define steps_stepgroupinfillregions_hpp_
...
namespace Steps::StepGroupInfillRegions {
...
#endif // steps_stepgroupinfillregions_hpp_
