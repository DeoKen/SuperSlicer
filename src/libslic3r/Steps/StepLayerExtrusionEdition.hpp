...
#ifndef steps_steplayerextrusionedition_hpp_
#define steps_steplayerextrusionedition_hpp_
...
namespace Steps::StepLayerExtrusionEdition {
...
#endif // steps_steplayerextrusionedition_hpp_
