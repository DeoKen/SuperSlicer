...
class SkeletalTrapezoidation
{
    ...
    static constexpr coord_t central_filter_dist = scale_i(0.02); //!< Filter areas marked as 'central' smaller than this
    static constexpr coord_t snap_dist = scale_i(0.02); //!< Generic arithmatic inaccuracy. Only used to determine whether a transition really needs to insert an extra edge.
