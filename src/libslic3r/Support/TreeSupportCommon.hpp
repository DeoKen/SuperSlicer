...
/*********************************************************************/
    coord_t                         layer_height                            { scale_i(0.15) };
    ...
    coord_t                         resolution                              { scale_i(0.025) };
    ...
    coord_t                         min_feature_size                        { scale_i(0.1) };
...
/*********************************************************************/
    ...
    coord_t                         support_line_width                      { scale_i(0.4) };
    // Support Roof Line Width: Width of a single support roof line.
    coord_t                         support_roof_line_width                 { scale_i(0.4) };
    ...
    coord_t                         support_bottom_height                   { scale_i(1.) };
    ...
    coord_t                         support_xy_distance                     { scale_i(0.7) };
    ...
    coord_t                         support_interface_skip_height           { scale_i(0.3) };
...
//    std::vector<double>             support_infill_angles                   {};
    ...
    double                          minimum_roof_area                       { scale_d(scale_d(1.)) };
    ...
    coord_t                         support_roof_line_distance              { scale_i(0.4) };
    ...
    coord_t                         minimum_support_area                    { scale_i(0.) };
    ...
    coord_t                         minimum_bottom_area                     { scale_i(1.0) };
    ...
    coord_t                         support_offset                          { scale_i(0.) };
...
/*********************************************************************/
    ...
    coord_t                         support_tree_branch_distance            { scale_i(1.) };
    ...
    coord_t                         support_tree_branch_diameter            { scale_i(2.) };
...
/*********************************************************************/
    ...
    // minimum: 0
    coord_t                         support_tree_max_diameter_increase_by_merges_when_support_to_model { scale_i(1.0) };
    ...
    coord_t                         support_tree_min_height_to_model        { scale_i(1.0) };
    ...
    coord_t                         support_tree_bp_diameter                { scale_i(7.5) };
    ...
    coord_t                         support_tree_tip_diameter               { scale_i(0.4) };
...
static constexpr const auto tiny_area_threshold = sqr(scale_d(0.001));
