...
static constexpr const coord_t SUPPORT_TREE_EXPONENTIAL_THRESHOLD = scale_i(1. * SUPPORT_TREE_EXPONENTIAL_FACTOR);
static constexpr const coord_t SUPPORT_TREE_COLLISION_RESOLUTION = scale_i(0.5);
