...
ProcessSurfaceResult PerimeterGenerator::process_arachne(const Parameters &params, int& loop_number, const Surface& surface, ExtrusionEntityCollection &loops) {
    ...
    if (loop_number > 0 &&
        (params.config.only_one_perimeter_top || params.has_many_config(&params.config.only_one_perimeter_top)) &&
            ...
            ExPolygons &fill_no_overlap)
{
    ...
    const int extra_odd_perimeter = (params.config.extra_perimeters_odd_layers && params.layer->id() % 2 == 1 &&
                                                         ...
                                                         ExtrusionEntityCollection &gap_fill)
{
    ...
    if (contour_count > 0 || holes_count > 0) {
        ...
        for (int perimeter_idx = 0;; ++perimeter_idx) {  // outer loop is 0
            ...
            if (perimeter_idx == 0 &&
                (params.config.only_one_perimeter_top ||
